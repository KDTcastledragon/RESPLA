...
import './SaledProductItem2.css';
import axios from 'axios';

function SaledProductItem2({ product_code, p_type, time_value, day_value, price, sell_count, refund_count, maxCount }) {
...
export default SaledProductItem2;